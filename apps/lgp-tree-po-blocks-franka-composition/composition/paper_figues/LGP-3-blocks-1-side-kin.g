...
body tableR{ type=9, X=<T t(0.0 -0.5 0.2)>, size=[1.5 0.5 .04 .01], color=[.2 .2 .7] }
body tableC{ type=9, X=<T t(0.5 0.0 0.2)>, size=[0.5 0.5 .04 .01], color=[.2 .2 .7] }
...
BELIEF_START_STATE { 
{
 ...
 shape id_b(block_3) { type=9 rel=<T t(0 0.05 0)> size=[ .1 .02 .1 .01] size=[.02 .1 .1 .01] color=[0 0 1] }
}
...
{
 shape id_r(block_3) { type=9 rel=<T t(-0.05 0 0.0)> size=[.02 .1 .1 .01] color=[1 0 0] }
 shape id_g(block_1) { type=9 rel=<T d(-270 0 0 1) t(-0.05 0 0.0)> size=[.02 .1 .1 .01] color=[0 1 0] }
 shape id_b(block_2) { type=9 rel=<T d(-90 0 1 0) t(-0.05 0 0.0)> size=[.02 .1 .1 .01] color=[0 0 1] }
}
