...
#table
body tableC{ type=9, X=<T t(0.7 0 1.0)>, size=[0.8 1.5 .04 .01], color=[.3 .3 .3] contact }
...
#shape a(block_1){ type=9 rel=<T t(0.05 0 0.0) > size=[0.27 0.19 0.03 0.01] color=[1 0 0]  }
